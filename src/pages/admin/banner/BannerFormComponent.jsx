...
const BannerFormComponent = ({ initialValue, submitAction }) => {
                        ...
                        <Col sm={3}>
                            {
                                formik.values && formik.values.image && typeof (formik.values.image) === 'object' ?
                                    ...
                                    : (
                                        formik.values && formik.values.image && typeof (formik.values.image)==='string' ? <img alt="" className="img img-fluid" src={process.env.REACT_APP_ASSETS_URL+"/uploads/banner/"+formik.values.image} />:<></>
                                    )
                            }
                        </Col>
                    </Row>
